<?php $rs = $this->usuario->listarUsuario(); ?>
<!-- <!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
                          ...
                          <td>
                            ...
                            <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown">Opciones
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                    <a href="?c=usuario&m=editar&id=<?php echo $row['ID']; ?>">
                                    <span class="glyphicon glyphicon-pencil"></span> Editar</a>
                                </li>
                                <li>
                                  <a href="?c=usuario&m=eliminar&id=<?php echo $row['ID']; ?>">
                                   <span class="glyphicon glyphicon-trash"></span> Eliminar</a>
                                </li>
                                 <li>
                                  <a href="?c=usuario&m=ver&id=<?php echo $row['ID']; ?>">
